...
Task:
1. Is the final answer explicitly supported by the retrieved evidence?
2. Can you directly quote or clearly trace the answer to the evidence?

If the answer CANNOT be directly supported by the retrieved evidence, output:
"JUDGEMENT: YES"

If the answer is clearly and explicitly supported, output:
"JUDGEMENT: NO
"""
...
def run_refine_extraction(llm, tokenizer, search_query, document_text):
    ...
    output = llm.generate([text_input], sampling_params=SamplingParams(max_tokens=1500, temperature=0.0))
